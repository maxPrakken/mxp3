...
public:
	...
	void renderTexture(Texture * texture, SDL_Rect * rect, SDL_RendererFlip flip);
	//renders spritesheet in scene
	void renderSpritesheet(Texture* texture, SDL_Rect chunk, SDL_Rect* rect);
	void renderSpritesheet(Texture * texture, SDL_Rect chunk, SDL_Rect * rect, SDL_RendererFlip flip);
	//gets resolution
